 ...
 * @author ACER
 */
public class EkstrakStegano {

     private BufferedImage stegFile;
    
    public EkstrakStegano(BufferedImage stegFile){
    ...
    public static void main(String[] args) throws IOException {
       BufferedImage stegFile = ImageIO.read(new File("Stegofile.png"));
       EkstrakStegano x = new EkstrakStegano(stegFile);
