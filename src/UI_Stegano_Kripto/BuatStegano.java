 ...
 * @author ACER
 */
public class BuatStegano {
     private BufferedImage cover;
    private RenderedImage BufferedImage;
    
    public BuatStegano(BufferedImage cover){
        this.cover = cover;
}
      ...
      public boolean sisipPesan(String pesan, String alamat) throws IOException{
        ...
        if(nPesan < (panjang * lebar)){
            ...
            File f = new File(alamat+"/Stegofile.png");
            ImageIO.write(this.cover, "png", f); 
...
//        BufferedImage cover = ImageIO.read(new File("HasilStegano.jpeg"));
//        BuatStegano buat = new BuatStegano(cover);
//        boolean b = buat.sisipPesan("Aku Anak Cerda,"+'\n'+" Selalu Optimis...","./");
//    }
}
